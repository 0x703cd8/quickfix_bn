...
namespace FIX
{
  namespace FIELD
  {
    ...
    const int InstrumentReqID = 320;
    const int InstrumentListRequestType = 559;
    ...
    const int ReqID = 6136;
    const int RecvWindow = 25000;
    const int NoLimitIndicators = 25003;
    const int LimitType = 25004;
    const int LimitCount = 25005;
    const int LimitMax = 25006;
    const int LimitResetInterval = 25007;
    const int LimitResetIntervalResolution = 25008;
    const int ErrorCode = 25016;
    const int MessageHandling = 25035;
    const int UUID = 25037;
    const int MinQtyIncrement = 25039;
    const int MarketMinTradeVol = 25040;
    const int MarketMaxTradeVol = 25041;
    const int MarketMinQtyIncrement = 25042;
    const int FirstBookUpdateID = 25043;
    const int LastBookUpdateID = 25044;
    ...
    const int StrategyID = 7940;
    const int DropCopyFlag = 9406;
    const int SelfTradePreventionMode = 25001;
    const int CancelRestrictions = 25002;
    const int TriggerTrailingDeltaBips = 25009;
    const int NoListTriggeringInstructions = 25010;
    const int ListTriggerType = 25011;
    const int ListTriggerTriggerIndex = 25012;
    const int ListTriggerAction = 25013;
    const int ClListID = 25014;
    const int OrigClListID = 25015;
    const int CumQuoteQty = 25017;
    const int OrderCreationTime = 25018;
    const int WorkingFloor = 25021;
    const int TrailingTime = 25022;
    const int WorkingTime = 25023;
    const int PreventedMatchID = 25024;
    const int PreventedExecutionPrice = 25025;
    const int PreventedExecutionQty = 25026;
    const int TradeGroupID = 25027;
    const int CounterSymbol = 25028;
    const int CounterOrderID = 25029;
    const int PreventedQty = 25030;
    const int LastPreventedQty = 25031;
    const int SOR = 25032;
    const int OrderCancelRequestAndNewOrderSingleMode = 25033;
    const int CancelClOrdID = 25034;
    const int ResponseMode = 25036;
    const int OrderRateLimitExceededMode = 25038;
    const int IOIID = 23;

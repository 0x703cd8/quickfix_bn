...
const char MsgType_LimitQuery[]								 = "XLQ";
const char MsgType_LimitResponse[]							 = "XLR";
const char MsgType_InstrumentListRequest[]					 = "x";
const char MsgType_InstrumentList[]							 = "y";
const char MsgType_MarketDataSnapshot[]						 = "W";
const char MsgType_OrderCancelRequestAndNewOrderSingle[]	 = "XCN";
const char MsgType_OrderAmendKeepPriorityRequest[]			 = "XAK";
const char MsgType_OrderAmendReject[]						 = "XAR";
...
const int SessionRejectReason_INCORRECT_NUM_IN_GROUP_COUNT_FOR_REPEATING_GROUP =
	16;
...
const char SecurityType_OFFSHORE_ISSUED_CHINESE_YUAN_CORPORATE_BOND[] =
	"DIMSUMCORP";
...
const char SecurityType_OFFSHORE_ISSUED_CHINESE_YUAN_SOVEREIGN_BOND[] =
	"DIMSUMSOV";
...
const char OrderRestrictions_ACTING_AS_MARKET_MAKER_OR_SPECIALIST_IN_SECURITY =
	'5';
...
const int  MultiLegRptTypeReq_REPORT_BY_MULTILEG_SECURITY_AND_INSTRUMENT_LEGS =
	1;
...
const char CustOrderHandlingInst_CLIENT_PROVIDED_PLATFORM_CONTROLLED_BY_FCM[] =
	"E";
const char CustOrderHandlingInst_CLIENT_PROVIDED_PLATFORM_DIRECT_TO_EXCHANGE[] =
	"F";
...
const char ValuationMethod_CDS_IN_DELIVERY_USE_RECOVERY_RATE_TO_CALCULATE[] =
	"CDSD";
...
const int
	SideClearingTradePriceType_TRADE_CLEARING_AT_ALTERNATE_CLEARING_PRICE  = 1;
...
const char
	ProtectionTermEventQualifier_RESTRUCTURING_MULTIPLE_HOLDING_OBLIGATIONS =
		'H';
const char
	ProtectionTermEventQualifier_RESTRUCTURING_MULTIPLE_CREDIT_EVENT_NOTICES =
		'E';
...
const int QuoteAttributeType_QUOTE_APPLICABLE_FOR_LIQUIDTY_PROVISION_ACTIVITY =
	2;

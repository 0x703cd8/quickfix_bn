...
namespace FIX
{
  ...
  DEFINE_STRING(InstrumentReqID);
  DEFINE_INT(InstrumentListRequestType);
  ...
  DEFINE_STRING(ReqID);
  DEFINE_INT(RecvWindow);
  DEFINE_NUMINGROUP(NoLimitIndicators);
  DEFINE_CHAR(LimitType);
  DEFINE_INT(LimitCount);
  DEFINE_INT(LimitMax);
  DEFINE_INT(LimitResetInterval);
  DEFINE_CHAR(LimitResetIntervalResolution);
  DEFINE_INT(ErrorCode);
  DEFINE_INT(MessageHandling);
  DEFINE_STRING(UUID);
  DEFINE_QTY(MinQtyIncrement);
  DEFINE_QTY(MarketMinTradeVol);
  DEFINE_QTY(MarketMaxTradeVol);
  DEFINE_QTY(MarketMinQtyIncrement);
  DEFINE_INT(FirstBookUpdateID);
  DEFINE_INT(LastBookUpdateID);
  ...
  DEFINE_INT(StrategyID);
  DEFINE_BOOLEAN(DropCopyFlag);
  DEFINE_CHAR(SelfTradePreventionMode);
  DEFINE_INT(CancelRestrictions);
  DEFINE_INT(TriggerTrailingDeltaBips);
  DEFINE_NUMINGROUP(NoListTriggeringInstructions);
  DEFINE_CHAR(ListTriggerType);
  DEFINE_INT(ListTriggerTriggerIndex);
  DEFINE_CHAR(ListTriggerAction);
  DEFINE_STRING(ClListID);
  DEFINE_STRING(OrigClListID);
  DEFINE_QTY(CumQuoteQty);
  DEFINE_UTCTIMESTAMP(OrderCreationTime);
  DEFINE_INT(WorkingFloor);
  DEFINE_UTCTIMESTAMP(TrailingTime);
  DEFINE_UTCTIMESTAMP(WorkingTime);
  DEFINE_INT(PreventedMatchID);
  DEFINE_PRICE(PreventedExecutionPrice);
  DEFINE_QTY(PreventedExecutionQty);
  DEFINE_INT(TradeGroupID);
  DEFINE_STRING(CounterSymbol);
  DEFINE_INT(CounterOrderID);
  DEFINE_QTY(PreventedQty);
  DEFINE_QTY(LastPreventedQty);
  DEFINE_BOOLEAN(SOR);
  DEFINE_INT(OrderCancelRequestAndNewOrderSingleMode);
  DEFINE_STRING(CancelClOrdID);
  DEFINE_INT(ResponseMode);
  DEFINE_INT(OrderRateLimitExceededMode);
  DEFINE_STRING(IOIID);
